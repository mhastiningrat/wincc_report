...
const CoalReclaiming = () => {
	return (
		<div>
			<h3 className="px-2 pt-4 border-bottom">COAL RECLAIMING (OUTGOING)</h3>
			<table className="table table-responsive table-bordered table-scroll">
				<thead>
					<tr>
						<th className=" p-2 text-center align-middle">Equipment</th>
						<th className=" p-2 text-center align-middle">Vessel Name</th>
						<th>
				...
				<tbody>
					<tr>
						...
						<td className=" p-2">
							<div className="d-flex justify-content-around">
								<div className="text-center   p-2">Data vessel</div>
							</div>
						</td>
						<td>
							<div className="d-flex justify-content-around">
					...
					<tr>
						<td className=" p-2">
							<div className="d-flex justify-content-around">
								<div className="text-center fw-bold  p-2">OLC#1 Bypass</div>
							</div>
						</td>
						<td className=" p-2">
							<div className="d-flex justify-content-around">
					...
					<tr>
						<td className=" p-2">
							<div className="d-flex justify-content-around">
								<div className="text-center fw-bold  p-2">OLC#2 Bypass</div>
							</div>
						</td>
						<td className=" p-2">
							<div className="d-flex justify-content-around">
					...
					<tr>
						<td colSpan={6}>
							<div className="d-flex justify-content-center bg-warning">
								<div className="text-center fw-bold p-2">TOTAL RECLAIMING</div>
							</div>
						</td>
						<td>
